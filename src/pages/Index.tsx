  ...
  const Navigation = () => {
    ...
    return (
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? "bg-card/95 backdrop-blur-lg shadow-lg" : "bg-transparent"
          }`}
      >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 z-10">
          {slides.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === index ? "bg-accent w-8" : "bg-foreground/50"
                }`}
            />
          ))}
        </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed"> Experience a fresh chapter of luxury at our newly opened hotel, where every room is thoughtfully designed to embrace the beauty of nature. The Hill View Rooms offer panoramic vistas of the majestic hills, while the Lake View Rooms provide a calming escape overlooking serene waters. </p> <p className="text-lg text-muted-foreground leading-relaxed"> For guests seeking the finest in comfort, our Premium Suites combine spacious interiors, elegant design, and world-class amenities to create an unforgettable stay. Whether you choose the hills, the lake, or the luxury of a suite, our hotel ensures a stay defined by peace, style, and sophistication. </p>
          </motion.div>
        </div>
      </section>
    );
    ...
    const rooms = [
      {
        ...
        features: ["King Bed", "Balcony", "AC", "Wi-Fi", "TV"],
      },
      {
        id: 2,
        name: "Family Rooms with Mountain view",
      ...
      },
      {
        ...
        features: ["Bedrooms", "Balcony", "Living Room", "Kitchenette", "Family Friendly"],
      },
      ...
      <section id="gallery" className="py-20 px-4 bg-card/50">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Glimpse into the luxury and elegance that awaits you at DJ Palace.
            </p>
          </motion.div>
            ...
            {images.map((image, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <p className="text-foreground font-semibold">DJ Palace</p>
                </div>
              </motion.div>
            ))}
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      51,banglore to pondy NH road,<br /> Asai nagar, Samuthram, Nallavan palayam,<br /> Thiruvannamalai, Tamil Nadu 606603
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6 hover-glow-purple">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      djpalaceandresidency@gmail.com
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-card border-t border-border py-12 px-4">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.instagram.com/djresidency_2025?utm_source=qr&igsh=aTA4eDU2bmV1d2U2" className="w-10 h-10 rounded-full bg-secondary hover:bg-primary transition-colors flex items-center justify-center">
                  <FaInstagram className="text-foreground" />
                </a>
                <a href="#" className="w-10 h-10 rounded-full bg-secondary hover:bg-primary transition-colors flex items-center justify-center">
                  <FaTwitter className="text-foreground" />
                </a>
                <a href="https://youtube.com/@varma_aari_boutiq_vlogs?si=Lz8HnOGwAVXGVh-0" className="w-10 h-10 rounded-full bg-secondary hover:bg-primary transition-colors flex items-center justify-center">
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-muted-foreground">
              © 2025 DJ Palace. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
